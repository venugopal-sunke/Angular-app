...
export class UserserviceService {
  ...
  sideMenu$:BehaviorSubject<any> = new BehaviorSubject(null);
  countValue$:BehaviorSubject<number> = new BehaviorSubject(null);
  
  setSideMenu(list: any){
    this.sideMenu$.next(list);
  }

  setCountValue(list: any){
    this.countValue$.next(list);
  }
